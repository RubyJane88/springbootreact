...
public class StudentDataAccessService {
    ...
    public List<Student> selectAllStudents() {
        ...
        //jdbc template
        // make a query to the database. maps the results to a Student object
        //returns a list of students
        //sql = "select * from student";
        //resultSet Extractor = new StudentRowMapper();. Maps the results to a Student object

        return jdbcTemplate.query(sql, mapStudentFromDb());
    }

    public int insertStudent(UUID studentId, Student student) {
        //SQL statements to allow us to insert new students to our table student in the database
        String sql = "" +
                "INSERT INTO student (" +
                " student_id, " +
                " first_name, " +
        ...
        //use JDBC template whenever we want to interact with our database
